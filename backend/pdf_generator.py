...
class ColdChainPDFReport:
    ...
    def generate(
        ...
        story.append(Paragraph("Automated Cold Chain Compliance Logger", subtitle_style))
        ...
        # Calculate stats
        violations = [r for r in readings if r.get('temperature') is not None
        ...
        summary_table.setStyle(TableStyle([
            ...
            ('TEXTCOLOR', (1, 5), (1, 5),
             self.success_color if compliance_rate >= 90 else self.danger_color),
